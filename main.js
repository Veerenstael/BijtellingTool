document.getElementById('bijtelling-form').addEventListener('submit', function(e) {
  ...
  document.getElementById('info').textContent = isElektrisch
    ? (bijtellingCap 
        ? `Voor het belastingjaar ${belastingjaar} en het jaar van op kenteken zetten ${kentekenjaar}, geldt voor een elektrische auto een bijtellingpercentage van ${bijtellingPercentage}% van de cataloguswaarde. Tot een maximum van €${bijtellingCap.toLocaleString('nl-NL')} wordt dit percentage toegepast. Bedragen boven dit maximum worden belast tegen 22%.` 
        : `Voor het belastingjaar ${belastingjaar} en het jaar van op kenteken zetten ${kentekenjaar}, geldt voor een elektrische auto een bijtellingpercentage van ${bijtellingPercentage}% over de volledige cataloguswaarde. Er is geen maximum voor de bijtelling.`)
    : `Voor het belastingjaar ${belastingjaar} en het jaar van op kenteken zetten ${kentekenjaar}, geldt voor een benzine/diesel auto een bijtelling van 22% over de volledige cataloguswaarde, zonder maximum.`;
});
